...
func NewCounter[V Value](name string, cfg CounterConfig) (_ *Counter[V]) {
	...
	//    https://github.com/encoredev/encore/blob/v1.48.13/runtimes/go/metrics/pkgfn.go#L7-L9
...
func NewCounterGroup[L Labels, V Value](name string, cfg CounterConfig) (_ *CounterGroup[L, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.48.13/runtimes/go/metrics/pkgfn.go#L16-L18
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewGauge[V Value](name string, cfg GaugeConfig) (_ *Gauge[V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.48.13/runtimes/go/metrics/pkgfn.go#L22-L24
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewGaugeGroup[L Labels, V Value](name string, cfg GaugeConfig) (_ *GaugeGroup[L, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.48.13/runtimes/go/metrics/pkgfn.go#L31-L33
	doPanic("encore apps must be run using the encore command")
	return
}

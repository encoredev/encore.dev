...
func (*Database) Stdlib() (_ *sql.DB) {
	...
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L61-L94
...
func (*Database) Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L161-L197
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L203-L241
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L246-L282
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) Begin(ctx context.Context) (_ *Tx, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L287-L310
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Driver[T SupportedDrivers](db *Database) (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L322-L329
	doPanic("encore apps must be run using the encore command")
	return
}
...
func DriverConn[T SupportedDriverConns](conn *sql.Conn, f func(driverConn T) error) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/sqldb/db.go#L352-L365
	doPanic("encore apps must be run using the encore command")
	return
}

...
func (*Database) Stdlib() (_ *sql.DB) {
	...
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L47-L78
...
func (*Database) Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L152-L176
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L182-L209
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L214-L239
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) Begin(ctx context.Context) (_ *Tx, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L244-L264
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Driver[T SupportedDrivers](db *Database) (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L276-L278
	doPanic("encore apps must be run using the encore command")
	return
}
...
func DriverConn[T SupportedDriverConns](conn *sql.Conn, f func(driverConn T) error) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/storage/sqldb/db.go#L301-L307
	doPanic("encore apps must be run using the encore command")
	return
}

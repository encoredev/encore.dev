...
func (*Database) Stdlib() *sql.DB {
	...
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/db.go#L46-L77
...
func (*Database) Exec(ctx context.Context, query string, args ...interface{}) (ExecResult, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/db.go#L152-L176
	panic("encore apps must be run using the encore command")
}
...
func (*Database) Query(ctx context.Context, query string, args ...interface{}) (*Rows, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/db.go#L182-L209
	panic("encore apps must be run using the encore command")
}
...
func (*Database) QueryRow(ctx context.Context, query string, args ...interface{}) *Row {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/db.go#L214-L239
	panic("encore apps must be run using the encore command")
}
...
func (*Database) Begin(ctx context.Context) (*Tx, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/db.go#L244-L264
	panic("encore apps must be run using the encore command")
}

...
func (*Database) Stdlib() (_ *sql.DB) {
	...
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L61-L94
...
func (*Database) Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L167-L203
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L209-L247
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L252-L288
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Database) Begin(ctx context.Context) (_ *Tx, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L293-L316
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Driver[T SupportedDrivers](db *Database) (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L328-L336
	doPanic("encore apps must be run using the encore command")
	return
}
...
func DriverConn[T SupportedDriverConns](conn *sql.Conn, f func(driverConn T) error) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/storage/sqldb/db.go#L359-L372
	doPanic("encore apps must be run using the encore command")
	return
}

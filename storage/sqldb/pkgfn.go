...
func Exec(ctx context.Context, query string, args ...interface{}) (ExecResult, error) {
	...
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L13-L15
...
func Query(ctx context.Context, query string, args ...interface{}) (*Rows, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L21-L23
	panic("encore apps must be run using the encore command")
}
...
func QueryRow(ctx context.Context, query string, args ...interface{}) *Row {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L28-L30
	panic("encore apps must be run using the encore command")
}
...
func Begin(ctx context.Context) (*Tx, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L35-L37
	panic("encore apps must be run using the encore command")
}
...
func Commit(tx *Tx) error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L43-L45
	panic("encore apps must be run using the encore command")
}
...
func Rollback(tx *Tx) error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L51-L53
	panic("encore apps must be run using the encore command")
}
...
func ExecTx(tx *Tx, ctx context.Context, query string, args ...interface{}) (ExecResult, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L59-L61
	panic("encore apps must be run using the encore command")
}
...
func QueryTx(tx *Tx, ctx context.Context, query string, args ...interface{}) (*Rows, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L67-L69
	panic("encore apps must be run using the encore command")
}
...
func QueryRowTx(tx *Tx, ctx context.Context, query string, args ...interface{}) *Row {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L75-L77
	panic("encore apps must be run using the encore command")
}
...
func Named(name constStr) *Database {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.11.0/runtime/storage/sqldb/pkgfn.go#L86-L88
	panic("encore apps must be run using the encore command")
}

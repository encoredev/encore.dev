...
func (*Tx) Commit() error {
	...
	//
	//	https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L42-L42
...
func (*Tx) Rollback() error {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L47-L47
	panic("encore apps must be run using the encore command")
}
...
func (*Tx) Exec(ctx context.Context, query string, args ...interface{}) (ExecResult, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L85-L87
	panic("encore apps must be run using the encore command")
}
...
func (*Tx) Query(ctx context.Context, query string, args ...interface{}) (*Rows, error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L114-L140
	panic("encore apps must be run using the encore command")
}
...
func (*Tx) QueryRow(ctx context.Context, query string, args ...interface{}) *Row {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L142-L168
	panic("encore apps must be run using the encore command")
}
...
func (*Rows) Close() {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L181-L181
	panic("encore apps must be run using the encore command")
}
...
func (*Rows) Scan(dest ...interface{}) error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L188-L188
	panic("encore apps must be run using the encore command")
}
...
func (*Rows) Err() error {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L194-L194
	panic("encore apps must be run using the encore command")
}
...
func (*Rows) Next() bool {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L204-L204
	panic("encore apps must be run using the encore command")
}
...
func (*Row) Scan(dest ...interface{}) error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L218-L231
	panic("encore apps must be run using the encore command")
}
...
func (*Row) Err() error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/storage/sqldb/sqldb.go#L233-L238
	panic("encore apps must be run using the encore command")
}

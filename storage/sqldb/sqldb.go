...
func (*Tx) Commit() (_ error) {
	...
	//
	//	https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L41-L41
...
func (*Tx) Rollback() (_ error) {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L46-L46
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Tx) Exec(ctx context.Context, query string, args ...interface{}) (_ ExecResult, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L84-L86
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Tx) Query(ctx context.Context, query string, args ...interface{}) (_ *Rows, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L113-L139
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Tx) QueryRow(ctx context.Context, query string, args ...interface{}) (_ *Row) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L141-L167
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Rows) Close() {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L180-L180
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Rows) Scan(dest ...interface{}) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L187-L187
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Rows) Err() (_ error) {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L193-L193
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Rows) Next() (_ bool) {
	...
	// The current implementation of this function can be found here:
	//
	//	https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L203-L203
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Row) Scan(dest ...interface{}) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L217-L230
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Row) Err() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/storage/sqldb/sqldb.go#L232-L237
	doPanic("encore apps must be run using the encore command")
	return
}

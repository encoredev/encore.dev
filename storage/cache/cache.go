...
func (*OpError) Error() (_ string) {
	...
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/cache.go#L120-L122
...
func (*OpError) Unwrap() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/cache.go#L124-L126
	doPanic("encore apps must be run using the encore command")
	return
}
...
func ExpireIn(dur time.Duration) (_ ExpiryFunc) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/cache.go#L166-L168
	doPanic("encore apps must be run using the encore command")
	return
}
...
func ExpireDailyAt(hour, minute, second int, loc *time.Location) (_ ExpiryFunc) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/cache.go#L172-L182
	doPanic("encore apps must be run using the encore command")
	return
}

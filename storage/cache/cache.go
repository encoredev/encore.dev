...
func (*OpError) Error() (_ string) {
	...
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/cache.go#L120-L122
...
func (*OpError) Unwrap() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/cache.go#L124-L126
	doPanic("encore apps must be run using the encore command")
	return
}
...
func ExpireIn(dur time.Duration) (_ ExpiryFunc) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/cache.go#L167-L169
	doPanic("encore apps must be run using the encore command")
	return
}
...
func ExpireDailyAt(hour, minute, second int, loc *time.Location) (_ ExpiryFunc) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/cache.go#L173-L183
	doPanic("encore apps must be run using the encore command")
	return
}

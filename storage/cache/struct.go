...
func NewStructKeyspace[K, V any](cluster *Cluster, cfg KeyspaceConfig) (_ *StructKeyspace[K, V]) {
	...
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L11-L27
...
func (*StructKeyspace[K, V]) With(opts ...WriteOption) (_ *StructKeyspace[K, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L39-L41
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) Get(ctx context.Context, key K) (_ V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L47-L49
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) Set(ctx context.Context, key K, val V) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L54-L56
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) SetIfNotExists(ctx context.Context, key K, val V) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L62-L64
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) Replace(ctx context.Context, key K, val V) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L70-L72
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) GetAndSet(ctx context.Context, key K, val V) (oldVal V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L78-L80
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) GetAndDelete(ctx context.Context, key K) (oldVal V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L86-L88
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StructKeyspace[K, V]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.25.0/runtime/storage/cache/struct.go#L97-L99
	doPanic("encore apps must be run using the encore command")
	return
}

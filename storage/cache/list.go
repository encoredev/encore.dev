...
func NewListKeyspace[K any, V BasicType](cluster *Cluster, cfg KeyspaceConfig) (_ *ListKeyspace[K, V]) {
	...
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L25-L32
...
func (*ListKeyspace[K, V]) With(opts ...WriteOption) (_ *ListKeyspace[K, V]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L45-L47
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L56-L58
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) PushLeft(ctx context.Context, key K, values ...V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L70-L85
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) PushRight(ctx context.Context, key K, values ...V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L97-L112
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) PopLeft(ctx context.Context, key K) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L118-L135
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) PopRight(ctx context.Context, key K) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L141-L157
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Len(ctx context.Context, key K) (length int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L164-L175
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Trim(ctx context.Context, key K, start, stop int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L187-L198
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Set(ctx context.Context, key K, idx int64, val V) (err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L208-L220
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Get(ctx context.Context, key K, idx int64) (val V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L230-L244
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Items(ctx context.Context, key K) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L251-L253
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) GetRange(ctx context.Context, key K, start, stop int64) (_ []V, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L263-L265
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) InsertBefore(ctx context.Context, key K, needle, newVal V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L297-L313
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) InsertAfter(ctx context.Context, key K, needle, newVal V) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L323-L339
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) RemoveAll(ctx context.Context, key K, needle V) (removed int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L348-L361
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) RemoveFirst(ctx context.Context, key K, count int64, needle V) (removed int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L370-L390
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) RemoveLast(ctx context.Context, key K, count int64, needle V) (removed int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L399-L419
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*ListKeyspace[K, V]) Move(ctx context.Context, src, dst K, fromPos, toPos ListPos) (moved V, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.27.0/runtime/storage/cache/list.go#L437-L455
	doPanic("encore apps must be run using the encore command")
	return
}

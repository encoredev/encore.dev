...
func NewStringKeyspace[K any](cluster *Cluster, cfg KeyspaceConfig) (_ *StringKeyspace[K]) {
	...
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L16-L25
...
func (*StringKeyspace[K]) Get(ctx context.Context, key K) (_ string, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L36-L38
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Set(ctx context.Context, key K, val string) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L43-L45
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) SetIfNotExists(ctx context.Context, key K, val string) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L51-L53
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Replace(ctx context.Context, key K, val string) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L59-L61
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) GetAndSet(ctx context.Context, key K, val string) (oldVal string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L67-L69
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) GetAndDelete(ctx context.Context, key K) (oldVal string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L75-L77
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L86-L88
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) With(opts ...WriteOption) (_ *StringKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L96-L98
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Append(ctx context.Context, key K, val string) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L108-L121
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) GetRange(ctx context.Context, key K, from, to int64) (val string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L135-L146
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) SetRange(ctx context.Context, key K, offset int64, val string) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L158-L171
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Len(ctx context.Context, key K) (length int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L178-L189
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewIntKeyspace[K any](cluster *Cluster, cfg KeyspaceConfig) (_ *IntKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L195-L204
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) With(opts ...WriteOption) (_ *IntKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L217-L219
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Get(ctx context.Context, key K) (_ int64, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L225-L227
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Set(ctx context.Context, key K, val int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L232-L234
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) SetIfNotExists(ctx context.Context, key K, val int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L240-L242
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Replace(ctx context.Context, key K, val int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L248-L250
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) GetAndSet(ctx context.Context, key K, val int64) (oldVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L256-L258
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) GetAndDelete(ctx context.Context, key K) (oldVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L264-L266
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L275-L277
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Increment(ctx context.Context, key K, delta int64) (newVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L289-L302
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Decrement(ctx context.Context, key K, delta int64) (newVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L314-L328
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewFloatKeyspace[K any](cluster *Cluster, cfg KeyspaceConfig) (_ *FloatKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L334-L343
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) With(opts ...WriteOption) (_ *FloatKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L356-L358
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Get(ctx context.Context, key K) (_ float64, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L364-L366
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Set(ctx context.Context, key K, val float64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L371-L373
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) SetIfNotExists(ctx context.Context, key K, val float64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L379-L381
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Replace(ctx context.Context, key K, val float64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L387-L389
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) GetAndSet(ctx context.Context, key K, val float64) (oldVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L395-L397
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) GetAndDelete(ctx context.Context, key K) (oldVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L403-L405
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L414-L416
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Increment(ctx context.Context, key K, delta float64) (newVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L428-L441
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Decrement(ctx context.Context, key K, delta float64) (newVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/cache/basic.go#L453-L466
	doPanic("encore apps must be run using the encore command")
	return
}

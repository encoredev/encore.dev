...
func NewStringKeyspace[K any](cluster *Cluster, cfg KeyspaceConfig) (_ *StringKeyspace[K]) {
	...
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L16-L25
...
func (*StringKeyspace[K]) Get(ctx context.Context, key K) (_ string, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L36-L38
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Set(ctx context.Context, key K, val string) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L43-L45
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) SetIfNotExists(ctx context.Context, key K, val string) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L51-L53
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Replace(ctx context.Context, key K, val string) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L59-L61
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) GetAndSet(ctx context.Context, key K, val string) (oldVal string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L67-L69
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) GetAndDelete(ctx context.Context, key K) (oldVal string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L75-L77
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L86-L88
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) With(opts ...WriteOption) (_ *StringKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L95-L97
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Append(ctx context.Context, key K, val string) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L107-L120
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) GetRange(ctx context.Context, key K, from, to int64) (val string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L134-L145
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) SetRange(ctx context.Context, key K, offset int64, val string) (newLen int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L157-L170
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*StringKeyspace[K]) Len(ctx context.Context, key K) (length int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L177-L188
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewIntKeyspace[K any](cluster *Cluster, cfg KeyspaceConfig) (_ *IntKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L194-L203
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) With(opts ...WriteOption) (_ *IntKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L215-L217
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Get(ctx context.Context, key K) (_ int64, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L223-L225
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Set(ctx context.Context, key K, val int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L230-L232
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) SetIfNotExists(ctx context.Context, key K, val int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L238-L240
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Replace(ctx context.Context, key K, val int64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L246-L248
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) GetAndSet(ctx context.Context, key K, val int64) (oldVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L254-L256
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) GetAndDelete(ctx context.Context, key K) (oldVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L262-L264
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L273-L275
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Increment(ctx context.Context, key K, delta int64) (newVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L287-L300
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*IntKeyspace[K]) Decrement(ctx context.Context, key K, delta int64) (newVal int64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L312-L326
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewFloatKeyspace[K any](cluster *Cluster, cfg KeyspaceConfig) (_ *FloatKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L332-L341
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) With(opts ...WriteOption) (_ *FloatKeyspace[K]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L353-L355
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Get(ctx context.Context, key K) (_ float64, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L361-L363
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Set(ctx context.Context, key K, val float64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L368-L370
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) SetIfNotExists(ctx context.Context, key K, val float64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L376-L378
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Replace(ctx context.Context, key K, val float64) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L384-L386
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) GetAndSet(ctx context.Context, key K, val float64) (oldVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L392-L394
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) GetAndDelete(ctx context.Context, key K) (oldVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L400-L402
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Delete(ctx context.Context, keys ...K) (deleted int, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L411-L413
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Increment(ctx context.Context, key K, delta float64) (newVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L425-L438
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*FloatKeyspace[K]) Decrement(ctx context.Context, key K, delta float64) (newVal float64, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.19.0/runtime/storage/cache/basic.go#L450-L463
	doPanic("encore apps must be run using the encore command")
	return
}

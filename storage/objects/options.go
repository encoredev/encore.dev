...
func WithVersion(version string) (_ withVersionOption) {
	...
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/storage/objects/options.go#L19-L21
...
func WithTTL(TTL time.Duration) (_ withTTLOption) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/storage/objects/options.go#L56-L58
	doPanic("encore apps must be run using the encore command")
	return
}
...
func WithPreconditions(pre Preconditions) (_ withPreconditionsOption) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/storage/objects/options.go#L79-L81
	doPanic("encore apps must be run using the encore command")
	return
}
...
func WithUploadAttrs(attrs UploadAttrs) (_ withUploadAttrsOption) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/storage/objects/options.go#L109-L111
	doPanic("encore apps must be run using the encore command")
	return
}

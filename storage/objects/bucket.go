...
func (*Bucket) Upload(ctx context.Context, object string, options ...UploadOption) (_ *Writer) {
	...
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L99-L131
...
func (*Bucket) PublicURL(object string, options ...PublicURLOption) (_ *url.URL) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L134-L150
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Writer) Write(p []byte) (_ int, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L170-L173
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Writer) Abort(err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L176-L182
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Writer) Close() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L185-L208
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) Download(ctx context.Context, object string, options ...DownloadOption) (_ *Reader) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L249-L277
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Reader) Err() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L292-L294
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Reader) Read(p []byte) (_ int, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L297-L306
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Reader) Close() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L310-L318
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) List(ctx context.Context, query *Query, options ...ListOption) (_ iter.Seq2[*ListEntry, error]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L415-L467
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) Remove(ctx context.Context, object string, options ...RemoveOption) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L470-L513
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) Attrs(ctx context.Context, object string, options ...AttrsOption) (_ *ObjectAttrs, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L530-L588
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) SignedUploadURL(ctx context.Context, object string, options ...UploadURLOption) (_ *SignedUploadURL, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L594-L614
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) SignedDownloadURL(ctx context.Context, object string, options ...DownloadURLOption) (_ *SignedDownloadURL, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L620-L640
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Bucket) Exists(ctx context.Context, object string, options ...ExistsOption) (_ bool, _ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.13/runtimes/go/storage/objects/bucket.go#L643-L702
	doPanic("encore apps must be run using the encore command")
	return
}

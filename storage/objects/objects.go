...
func NewBucket(name string, cfg BucketConfig) (_ *Bucket) {
	...
	//    https://github.com/encoredev/encore/blob/v1.52.1/runtimes/go/storage/objects/objects.go#L8-L10
...
func Named(name constStr) (_ *Bucket) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.1/runtimes/go/storage/objects/objects.go#L20-L22
	doPanic("encore apps must be run using the encore command")
	return
}

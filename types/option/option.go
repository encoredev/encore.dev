...
func (Option[T]) MarshalJSON() (_ []byte, _ error) {
	...
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L16-L21
...
func (*Option[T]) UnmarshalJSON(data []byte) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L23-L33
	doPanic("encore apps must be run using the encore command")
	return
}
...
func FromComparable[T comparable](v T) (_ Option[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L37-L45
	doPanic("encore apps must be run using the encore command")
	return
}
...
func FromPointer[T any](v *T) (_ Option[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L48-L53
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Some[T any](v T) (_ Option[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L56-L58
	doPanic("encore apps must be run using the encore command")
	return
}
...
func None[T any]() (_ Option[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L61-L63
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) IsSome() (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L66-L68
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) IsNone() (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L71-L73
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) IsZero() (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L76-L78
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) Get() (val T, ok bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L86-L88
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) GetOrElse(alternative T) (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L91-L96
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) GetOrElseF(alternative func() T) (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L99-L104
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) MustGet() (_ T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L107-L112
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) OrElse(alternative T) (_ Option[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L115-L120
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) Contains(predicate func(v T) bool) (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L123-L128
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) String() (_ string) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L130-L135
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) GoString() (_ string) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L137-L142
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Option[T]) PtrOrNil() (_ *T) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L145-L150
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Equal[T comparable](a, b Option[T]) (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L154-L162
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Contains[T comparable](option Option[T], matches T) (_ bool) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L165-L170
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Map[T, R any](option Option[T], f func(T) R) (_ Option[R]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.57.5/runtimes/go/types/option/option.go#L173-L178
	doPanic("encore apps must be run using the encore command")
	return
}

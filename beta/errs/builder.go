...
func B() (_ *Builder) {
	...
	//
	//	https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L27-L27
...
func (*Builder) Code(c ErrCode) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L30-L34
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Msg(msg string) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L37-L40
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Msgf(format string, args ...interface{}) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L43-L46
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Meta(metaPairs ...interface{}) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L49-L52
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Details(det ErrDetails) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L55-L59
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Cause(err error) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L62-L77
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Err() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/beta/errs/builder.go#L87-L117
	doPanic("encore apps must be run using the encore command")
	return
}

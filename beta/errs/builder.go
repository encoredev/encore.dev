...
func B() (_ *Builder) {
	...
	//
	//	https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L25-L25
...
func (*Builder) Code(c ErrCode) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L28-L32
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Msg(msg string) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L35-L38
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Msgf(format string, args ...interface{}) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L41-L44
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Meta(metaPairs ...interface{}) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L47-L50
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Details(det ErrDetails) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L53-L57
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Cause(err error) (_ *Builder) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L60-L71
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Builder) Err() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/builder.go#L81-L109
	doPanic("encore apps must be run using the encore command")
	return
}

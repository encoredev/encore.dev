...
func Wrap(err error, msg string, metaPairs ...interface{}) (_ error) {
	...
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L66-L82
...
func WrapCode(err error, code ErrCode, msg string, metaPairs ...interface{}) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L86-L101
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Convert(err error) (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L106-L117
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Code(err error) (_ ErrCode) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L122-L129
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Meta(err error) (_ Metadata) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L133-L138
	doPanic("encore apps must be run using the encore command")
	return
}
...
func Details(err error) (_ ErrDetails) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L142-L147
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Error) Error() (_ string) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L150-L155
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Error) ErrorMessage() (_ string) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L159-L183
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Error) Unwrap() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L186-L188
	doPanic("encore apps must be run using the encore command")
	return
}
...
func HTTPError(w http.ResponseWriter, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/errs/error.go#L196-L198
	doPanic("encore apps must be run using the encore command")
	return
}

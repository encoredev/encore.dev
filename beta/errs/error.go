...
func Wrap(err error, msg string, metaPairs ...interface{}) error {
	...
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L66-L82
...
func WrapCode(err error, code ErrCode, msg string, metaPairs ...interface{}) error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L86-L102
	panic("encore apps must be run using the encore command")
}
...
func Convert(err error) error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L107-L118
	panic("encore apps must be run using the encore command")
}
...
func Code(err error) ErrCode {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L123-L130
	panic("encore apps must be run using the encore command")
}
...
func Meta(err error) Metadata {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L134-L139
	panic("encore apps must be run using the encore command")
}
...
func Details(err error) ErrDetails {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L143-L148
	panic("encore apps must be run using the encore command")
}
...
func (*Error) Error() string {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L151-L153
	panic("encore apps must be run using the encore command")
}
...
func (*Error) ErrorMessage() string {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L157-L181
	panic("encore apps must be run using the encore command")
}
...
func (*Error) Unwrap() error {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L184-L186
	panic("encore apps must be run using the encore command")
}
...
func HTTPError(w http.ResponseWriter, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.9.3/runtime/beta/errs/error.go#L193-L195
	panic("encore apps must be run using the encore command")
}

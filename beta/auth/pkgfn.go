...
func UserID() (UID, bool) {
	...
	//    https://github.com/encoredev/encore/blob/v1.10.1/runtime/beta/auth/pkgfn.go#L11-L13
...
func Data() any {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.10.1/runtime/beta/auth/pkgfn.go#L24-L26
	panic("encore apps must be run using the encore command")
}

...
func UserID() (_ UID, _ bool) {
	...
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/auth/pkgfn.go#L13-L15
...
func Data() (_ any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.16.2/runtime/beta/auth/pkgfn.go#L25-L27
	doPanic("encore apps must be run using the encore command")
	return
}

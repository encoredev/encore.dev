...
func (Ctx) Debug(msg string, keysAndValues ...any) {
	...
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/rlog/rlog.go#L90-L94
...
func (Ctx) Info(msg string, keysAndValues ...any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/rlog/rlog.go#L99-L103
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Ctx) Warn(msg string, keysAndValues ...any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/rlog/rlog.go#L108-L112
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Ctx) Error(msg string, keysAndValues ...any) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/rlog/rlog.go#L117-L121
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (Ctx) With(keysAndValues ...any) (_ Ctx) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.13.0/runtime/rlog/rlog.go#L126-L136
	doPanic("encore apps must be run using the encore command")
	return
}

...
func (*Topic[T]) Meta() (_ TopicMeta) {
	...
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/pubsub/topic.go#L93-L98
...
func (*Topic[T]) Publish(ctx context.Context, msg T) (id string, err error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.0/runtimes/go/pubsub/topic.go#L106-L202
	doPanic("encore apps must be run using the encore command")
	return
}

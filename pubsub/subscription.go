...
func NewSubscription[T any](topic *Topic[T], name string, cfg SubscriptionConfig[T]) (_ *Subscription[T]) {
	...
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/pubsub/subscription.go#L58-L213
...
func (*Subscription[T]) Meta() (_ SubscriptionMeta[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/pubsub/subscription.go#L230-L236
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Subscription[T]) Config() (_ SubscriptionConfig[T]) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.17.0/runtime/pubsub/subscription.go#L240-L242
	doPanic("encore apps must be run using the encore command")
	return
}

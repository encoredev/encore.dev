...
func (*Request) WithContext(ctx context.Context) (_ Request) {
	...
	//    https://github.com/encoredev/encore/blob/38dbb67953561748253891e3e50181bdf095d6e5/runtime/middleware/middleware.go#L44-L48
...
func (*Request) Context() (_ context.Context) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/38dbb67953561748253891e3e50181bdf095d6e5/runtime/middleware/middleware.go#L51-L53
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Request) Data() (_ *encore.Request) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/38dbb67953561748253891e3e50181bdf095d6e5/runtime/middleware/middleware.go#L56-L58
	doPanic("encore apps must be run using the encore command")
	return
}
...
func NewRequest(ctx context.Context, data *encore.Request) (_ Request) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/38dbb67953561748253891e3e50181bdf095d6e5/runtime/middleware/middleware.go#L99-L104
	doPanic("encore apps must be run using the encore command")
	return
}

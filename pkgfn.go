...
func Meta() (_ *AppMetadata) {
	...
	//    https://github.com/encoredev/encore/blob/v1.52.1/runtimes/go/pkgfn.go#L16-L18
...
func CurrentRequest() (_ *Request) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.52.1/runtimes/go/pkgfn.go#L26-L28
	doPanic("encore apps must be run using the encore command")
	return
}
